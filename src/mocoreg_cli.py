...
def prepare_argparser():
    ...
    parser.add_argument(
        "input_filename", help="Name of the 4D BMode Matlab file to be analyzed."
    )
    parser.add_argument(
        "transforms_filename", help="Name of the file to store registration transforms."
    )
    parser.add_argument(
        "-b",
        "--bits",
    ...
    parser.add_argument(
        "-f", "--frames", default=200, type=int, help="Number of frames (default=200)"
    )
    parser.add_argument(
        "-l", "--laterals", default=92, type=int, help="Number of laterals (default=92)"
    )
    parser.add_argument(
        "-d", "--depths", default=153, type=int, help="Number of depths (default=152)"
    )
    parser.add_argument(
        "-e",
        "--elevations",
